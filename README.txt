...
The demographic data and the volume data as given by ms. Anneke are in the
inputData folder in excel files.
...
This code only runs in a linux environment and needs the libraries "nighres" and "nibabel".
